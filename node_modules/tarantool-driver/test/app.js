...
describe('requests', function(){
	...
	it('evaluate box select delete', function(done){
    conn.eval(`for key, value in ipairs(box.space.tags:select('774d49db1ff3ed62ee01399ab0917dcf')) do box.space.tags:delete(value) end`)
      .then(() => {
        done();
      })
      .catch((error) => {
	...
	it('evalutate box select delete 2', async function(done){
	  try {
      const connection = new TarantoolConnection({host: 'localhost', port: 33013, username: 'test', password: 'test'});
      // console.log('before insert')
      // await connection.insert('tags', ['774d49db1ff3ed62ee01399ab0917dcf'])
      // console.log('after insert')
      connection.eval(`for key, value in ipairs(box.space.tags:select('774d49db1ff3ed62ee01399ab0917dcf')) do box.space.tags:delete(value) end`)
        .then(() => {
          console.log('Successful deleting old tags in cache');
          done()
        })
        .catch((error) => {
          console.log(error);
